...
const Testimonials = () => {
  ...
  return (
    ...
    <section className="py-6 md:py-16 rounded-t-[60px] px-5 md:px-10 lg:px-20 mb-2 md:mb-16">
          <h2 className="text-left text-xl md:text-3xl font-semibold mb-4">The proof is in the numbers</h2>
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                ...
                <div className="relative w-32 h-32 flex items-center justify-center rounded-full border-2 border-orange-300">
                  ...
                  <span className="absolute bottom-3 text-orange-500 text-xl">↑</span>
                </div>
                </div>
                <p className="mt-2 md:mt-4 text-md md:text-lg font-medium text-black">{stat.label}</p>
              </div>
            ))}
          </div>

          <div className="bg-orange-200 text-center px-10 py-10 md:px-20 md:py-15 rounded-[40px] lg:w-1/3 w-full">
            <h3 className="text-4xl font-bold mb-2">282,000+</h3>
