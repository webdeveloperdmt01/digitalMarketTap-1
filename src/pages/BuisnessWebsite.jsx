...
import BuisnessWebsite1 from "../assets/buisness1.png";
import BuisnessWebsite2 from "../assets/buisness2.png";
     ...
     <div className="bg-gradient-to-b from-[#fdf1e7] to-white px-5 md:px-10 lg:px-30">
       <div className="pb-4 pt-22">
          <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30">
            <div>
               <h3 className="uppercase text-sm font-bold tracking-widest text-black mb-3 md:mb-6 lg:mb-8">Business Website</h3>
