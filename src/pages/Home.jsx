  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Boost your online presence with Digital Market Tap – the leading digitalmarketing agency in Delhi. SEO, PPC, Social Media, Web Design & more.Get results now!"
        />
        <meta
          name="keywords"
          content="Best digital marketing agency, digital marketing agency in delhi, digital marketing company in delhi, digital marketing company in india "
        />
          ...
          <div className="max-w-8xl mx-auto grid md:grid-cols-2 gap-3 md:gap-6 items-start">
            ...
            <div className="font-Kanit font-light text-gray-700 text-md space-y-4 text-justify md:px-6 lg:px-14 pb-2 md:pb-12">
              <h6>
                ...
                satisfied clients and worked with over a hundred brands, and
                with the help of a highly experienced and trained expert team,
                we have never failed to deliver the best result-oriented
                services. .{" "}
              </h6>
              <a
                href="/about-us"
                className="font-syne inline-block text-sm font-semibold text-black border-b-3 border-[#f7c881] hover:border-[#F89E1B] transition duration-200"
              >
                MORE ABOUT US
              </a>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2  lg:grid-cols-3 gap-6">
            <div className="text-left px-5 md:px-6 lg:px-8 py-10 border border-[#f1f1f1] rounded-[30px] md:rounded-[40px] bg-white">
              <div className="flex items-center gap-4 mb-6 justify-between">
                ...
                <div className="bg-[#f6f5f9] rounded-full w-16 h-16 flex items-center justify-center">
                  <FaBullhorn className="text-[#f89e1b] hover:text-black text-2xl" />
                </div>
              </div>
              <h6 className="text-[#5c5f61] font-light text-sm md:text-md">
                ...
                ads. Choosing a better audience is a key factor in getting
            ...
            <div className="text-left px-5 md:px-6 lg:px-8 py-10 border border-[#f1f1f1] rounded-[30px] md:rounded-[40px] bg-white">
              ...
              <h6 className="text-[#5c5f61] font-light text-sm md:text-md">
                ...
                means better results. Whether you want SEO service, ads, or
                social media, we track, measure, and optimize every move
              </h6>
            </div>
            ...
            <div className="text-left px-5 md:px-6 lg:px-8 py-10 border border-[#f1f1f1] rounded-[30px] md:rounded-[40px] bg-white">
              <div className="flex items-center justify-between gap-4 mb-6">
                ...
                <div className="bg-[#f6f5f9] rounded-full w-16 h-16 flex items-center justify-center">
                  <FaRupeeSign className="text-[#f89e1b] hover:text-black text-2xl" />
                </div>
              </div>
              <h6 className="text-[#5c5f61] font-light text-sm md:text-md">
        ...
        <section className="px-5 md:px-10 lg:px-15 xl:px-30 pt-5">
          ...
          <div className="max-w-2xl text-left px-0 md:px-5 lg:px-2">
            ...
            <h2 className="text-2xl md:text-5xl font-bold text-black mb-6 leading-tight">
              {" "}
              Smart digital marketing Solutions centred on data and your
              audience
            </h2>
