  ...
  <section aria-labelledby="seo-heading" className="bg-gradient-to-b from-[#fdf1e7] to-white pt-10 md:pt-18 pb-6 md:pb-8 px-5 md:px-16 lg:px-30">
    <div>
        ...
        <h3 className="text-2xl md:text-5xl font-semibold text-black mb-2 md:mb-6 text-center">Various Countries various Language <span className="hover:text-[#f89e1b] cursor-pointer"> Barriers</span></h3>
         <p className="text-gray-600 text-sm md:text-md text-center">A small river named Duden flows by their place and supplies it with the necessary regelialia. <br />It is a paradisematic country, in which...</p>
    <div className="max-w-md mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            <NavLink to="/" className="group bg-[#f89e1b] text-white px-5 py-3 md:px-10 md:py-4 rounded-[30px] text-sm font-semibold border border-transparent hover:bg-white hover:text-[#f89e1b] hover:border-[#f89e1b] transition duration-300 relative overflow-hidden text-center">
                <span className="relative z-10">PURCHASE NOW</span>
            </NavLink>

            <NavLink to="/" className=" group bg-white text-[#f89e1b] border border-[#f89e1b] px-5 py-3 md:px-10 md:py-4 rounded-[30px] text-sm font-semibold hover:bg-[#f89e1b] hover:text-white transition duration-300 relative overflow-hidden text-center">
