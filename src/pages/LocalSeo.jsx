...
export default function LocalSeoPage() {
  ...
  return (
    ...
    <div className="pt-4 md:pt-8 lg:pt-12 pb-4">
      ...
      <div className="pb-4 pt-8 md:pt-12 lg:pt-18 max-w-5xl mx-auto">
        ...
        <p className="text-center text-md font-base text-gray-500 pb-4">
          Looking to learn more about paid search management for your business? Browse our
          FAQs
        </p>
        <div className="pt-8 space-y-2 md:space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="border-t border-gray-300 pb-2 md:pb-4">
              ...
              {openIndex === index && (
                <p className="mt-3 text-gray-500 text-xs font-semibold md:text-md">{faq.answer}</p>
              )}
            </div>
          ))}
        </div>
