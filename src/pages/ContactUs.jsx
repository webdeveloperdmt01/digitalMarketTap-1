            ...
            <div className="bg-white rounded-4xl shadow-[12px_12px_0_0_black] px-2 lg:px-5 pt-14 lg:pt-20 pb-5 lg:pb-10 relative max-w-[490px] w-full">
              ...
              >
                <input
                  ...
                  className={`w-full px-3 py-2 md:px-4 md:py-3 border ${errors.name ? "border-red-500" : "border-[#ababab]"
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 md:px-4 md:py-3 border ${errors.email ? "border-red-500" : "border-[#ababab]"
                    } hover:border-[#f89e1b] rounded-[8px] outline-none`}
                />
                {errors.email && (
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 md:px-4 md:py-3 border ${errors.company ? "border-red-500" : "border-[#ababab]"
                    } hover:border-[#f89e1b] rounded-[8px] outline-none`}
                />
                {errors.company && (
                ...
                <input
                  ...
                  onChange={handleChange}
                  maxLength="10"
                  className={`w-full px-3 py-2 md:px-4 md:py-3 border ${errors.phone ? "border-red-500" : "border-[#ababab]"
                    } hover:border-[#f89e1b] rounded-[8px] outline-none`}
                  inputMode="numeric"
                />
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 md:px-4 md:py-3 border ${errors.service ? "border-red-500" : "border-[#ababab]"
                    } hover:border-[#f89e1b] rounded-[8px] outline-none`}
                >
        ...
        <div className="pt-10 lg:pt-18 relative">
          ...
          <div className="w-full bg-[#f7f7fa] rounded-4xl px-4 lg:px-8 py-8 md:py-12 space-y-4">
            <div className="flex flex-col items-start gap-4">
             ...
             FF, Metro Station, Plot 32A, Najafgarh Rd, Dwarka Mor, Shanti Park, Dwarka, New Delhi, Delhi, 110059
              </p>
            </div>
            ...
            <a
              href="https://www.google.com/maps?q=Digital+Market+Tap"
              target="_blank"
