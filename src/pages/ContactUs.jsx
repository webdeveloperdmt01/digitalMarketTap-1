  ...
  return (
    <section className="bg-gradient-to-b from-[#fdf1e7] to-white py-8 lg:py-20 px-5 md:px-10 lg:px-34">
      <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
        <div>
          ...
          <div className="mt-4 lg:mt-10 block lg:flex justify-between items-start w-full">
            <p className="text-black text-xl group mb-4 lg:mb-0">
              ...
              <a href="tel:+917290969680" className="relative inline-block cursor-pointer text-black no-underline">
                +91-7290969680
            ...
            <p className="text-black text-xl group">
              ...
              <a href="mailto:info@digitalmarkettap.com" className="relative inline-block cursor-pointer text-black no-underline">
        ...
        <div className="flex lg:justify-end justify-center pt-2.5 pr-2.5 pb-2.5 pl-0 lg:p-0">
          <div className="bg-white rounded-4xl shadow-[12px_12px_0_0_black] px-2 lg:px-5 pt-14 lg:pt-20 pb-5 lg:pb-10 relative max-w-[490px] w-full">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-4 text-[#a4a4a4] px-4">
              <input
                type="text"
                name="name"
      ...
      <div className="pt-10 lg:pt-18 relative">
        <img src={BorderBottomCenter} alt="border-bottom-line" className="w-full top-0 bottom-0 right-0 object-contain pb-3 md:pb-24" />
        <h2 className="text-4xl lg:text-5xl font-bold text-black mb-6 lg:mb-12">Location</h2>
