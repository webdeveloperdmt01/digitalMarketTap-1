...
const EcommerceWebsiteDevelopment = () => {
    ...
    <div className="bg-gradient-to-b from-[#fdf1e7] to-white px-5 md:px-10 lg:px-30">
       <div className="pb-4 pt-22">
          <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30">
            <div>
               <h3 className="uppercase text-sm font-bold tracking-widest text-black mb-3 md:mb-6 lg:mb-8">E-commerce Website</h3>
  ...
  <div className="pt-5 pb-10">
           <div className="max-w-7xl mx-auto rounded-[40px] overflow-hidden mb-8 md:mb-12">
             <img src={EcommerceWebsiteDevelopment2} alt="Team Collaboration" className="w-full h-[155px] md:h-[285px] lg:h-[520px] object-fit" />
           </div>
