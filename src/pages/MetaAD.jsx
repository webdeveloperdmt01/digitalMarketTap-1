...
const services = [
  {
    ...
    description:
      "With over a billion active users on Instagram, Facebook, and Messenger, running Meta ads will be a smart choice for your brand. By targeting your specific niche, it increases your chance to reach your potential customers, which is great for brand visibility and awareness.",
  },
  {
    icon: <FaUserTie className="text-2xl text-[#f89e1b] hover:text-black" />,
    title: "Very Cost-Effective Advertising",
    description:
      "You do not require a huge budget to begin with Meta ads. Start small, according to your requirements. Prioritize specific targeting of the audience and target the geographical location. You can always change your ad sets later as per performance and objectives.",
  },
  {
    icon: <FaGoogle className="text-2xl text-[#f89e1b] hover:text-black" />,
    title: "Increase genuine leads & sales.",
    description:
      "With over a billion active users, Meta platforms such as Facebook and Instagram are very powerful for brand visibility. Intelligent targeting of the audience and geographical location can lead to digital growth, quality lead generation, and sales boosts effectively.",
  },
];
...
const faqs = [
  {
    question: "Are Meta Ads suitable for small businesses?",
    answer:
      " Yes, if you have a startup and want to generate brand awareness for your business, Meta ads are the best service you can get. It's great for brand awareness and visibility and quickly boosts your business.",
  },
  {
    question: " What is the minimum budget for Facebook and Instagram ads?",
    answer:
      "The minimum daily budget for Meta ads is ₹80–₹100 per day. It's flexible, and you can adjust it according to your needs, but Facebook suggests investing at least 500 for better results.",
  },
  {
    question: " Is it necessary to hire an agency for running Meta Ads?",
    answer:
      " Yes, in today's fast digital world where trends keep on changing, it's very essential for every business to hire an experienced digital marketing agency for better growth.",
  },
      ...
      <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30">
       ...
       Meta ads
          ...
          <h6 className="text-lg text-gray-500 mt-5 mb-10 font-light">
           In today's fast digital environment, making the right people at the right moment is the
key to business success. The ad platform for Facebook, Instagram, Messenger, and
Audience Network provides a powerful means of engaging with customers.
      ...
      <div className="max-w-7xl mx-auto pt-8 md:pt-22 lg:pt-28 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 lg:gap-28 items-start">
        <div>
          ...
          Why are Meta ads important for your business?

          </h3>
          <h6 className="text-gray-500 text-sm md:text-md lg:text-md font-light">
          If you want to quickly grow your business, Meta ads are the most powerful way.
Because with a billion meta active users across meta platforms, you can contact a vast
audience, and it includes:
        ...
        <div className="border-l-1 border-gray-300 pl-4 md:pl-16 lg:pl-26 space-y-4">
          {[
            ...
            "Have Multiple Ad Formats",
            "Great for Advanced Targeting",
     ...
     Why choose Digital Market Tap for your Meta Ads service?
     ...
     High-Performing Meta Ads
        ...
        Looking for an expert Meta Ads service management provider for your business? You
are at the right place. We provide the best digital marketing service in Delhi, India. By
handling ads for over 5000+ businesses, which makes us an expert Meta Ads service
provider. Our digital marketing strategies are known for providing outstanding results in
today's fast-moving digital world. When everything is available digitally, it's important for
every business to build its strong digital presence. <br /> <br /> We make sure to target the right
audience for your business according to your niche to drive genuine leads, boost sales,
and drive engagement to grow your digital performance.
      ...
      <div className="pt-8 md:pt-14 lg:pt-24">
        <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30 items-center">
          <div>
            <h3 className="text-xl md:text-3xl lg:text-4xl font-semibold text-black mb-2 md:mb-6 lg:mb-8">
Best Practices for High-Performing Meta Ads

            </h3>
            <h6 className="text-sm lg:text-[16px] font-base text-[#545e5b] mt-2 font-light">
              In 2025, Meta Ads continues to be among the best digital marketing tools for reaching
targeted audiences, fostering engagement, and increasing sales. Whether your
company is a startup trying to create brand awareness or an established corporation
seeking to grow
      ...
      Benefits of Using Meta Ads for Your Business
        </h1>
      ...
      <div className="pb-4 pt-8 md:pt-12 lg:pt-18">
        ...
        <h1 className="text-3xl lg:text-5xl text-center font-semibold pb-4">
         How can Meta ads boost your business effectively?
        ...
        <div className="w-full">
          <div className="max-w-8xl mx-auto grid md:grid-cols-2  lg:grid-cols-3 gap-6 pt-4">
            ...
            growth in leads who got our Meta Ads service
              </h6>
            </div>
            <div className="text-left px-8 py-10 border border-[#E2E2E2] rounded-[40px] bg-white">
              <div className="flex items-center gap-4 mb-6 justify-between">
              ...
              <h6 className="text-[#5c5f61] font-light">
            growth in engagement for those who got our Meta Ads service.
            ...
            <div className="text-left px-8 py-10 border border-[#E2E2E2] rounded-[40px] bg-white">
              ...
              <h6 className="text-[#5c5f61] font-light">
              growth in brand visibility for those who got our Meta Ads service.
          ...
          <div className="pb-4 pt-8 md:pt-12 lg:pt-18">
              ...
              <h6 className="text-center text-md md:text-lg font-light text-gray-500 pb-4">
                Looking to learn more about Meta Ads for your business?
                Browse our FAQs
              </h6>
            </div>
