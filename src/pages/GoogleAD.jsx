...
const tabs = [
  {
    ...
    content: {
      heading: "Display ads",
      about:
        "Display ads are graphic ads (images, banners, or responsive ads) that show up throughout the web on sites associated with Google. Unlike search ads, which appear when consumers search actively for keywords, display ads target users by demographics, interests, and behaviors online.",
    },
  },
  {
    title: "Search ads",
    content: {
      heading: "Search ads",
      about:
        "Search ads are advertisements that appear in the Google search engine whenever we type any keywords. They are the businesses that appear on top of the Google search engine results and attract high-quality traffic. It's great for a high-intent audience and getting measurable ROI.",
    },
  },
  {
    title: "Shopping ads",
    content: {
      heading: "Shopping ads",
      about:
        "Shopping ads are advertisements that appear in the Google Shopping section when you search for anything. It displays your product image with the price and store name. It's highly effective for e-commerce businesses. And great for higher buyer intent and easy performance tracking.",
    },
  },
  {
    title: "Video ads",
    content: {
      heading: "Video ads",
      about:
        "Google video ads are the type of ads that appear on YouTube and Google-powered websites, great for more clarity and brand visibility. These videos appear after, between, and before the videos in any YouTube videos. It's cost-efficient and highly engaging.",
    },
  },
  {
    title: "App ads",
    content: {
      heading: "App ads",
      about:
        "App ads are the type of ads that appear in apps and ask for an upgrade when we want to skip those ads. App ads are great for new product launches or the latest sales regarding updates because they build brand awareness quickly.",
    },
  },
];
    ...
    >
      <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30 items-center">
        <div>
          ...
          <h6 className="text-md text-gray-500 mt-5 mb-10 font-light">
            Digital Market Tap provides professional Google Ads management to
            enable businesses to reach the correct audience, get more traffic to
            the website, and have higher conversions. Google Ads, also referred
            to as Pay-Per-Click (PPC) adverts, is among the best methods of
      ...
      <div className="max-w-7xl mx-auto pt-8 md:pt-22 lg:pt-42 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 lg:gap-28 items-start">
        <div>
          ...
          <h6 className="text-gray-600 font-light text-sm md:text-md max-w-2xl">
            Google is a very powerful platform for businesses that want a boost
            in brand awareness. It can give your business an instant boost in
            online visibility and sales. Here is why it can be helpful:
          </h6>
        </div>
      ...
      <div className="pt-8 md:pt-14 lg:pt-24">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-5xl text-center font-semibold pb-10 lg:pb-24">
          Google Ads Services—Drive Traffic and Sales with Paid Advertising
        </h1>
        <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-15">
          ...
          <div className="pl-2 md:pl-8 lg:pl-20">
            ...
            <h6 className="text-sm lg:text-[16px] font-base text-[#545e5b] mt-2 font-light">
              We all know Google is a one-stop solution for all problems; if you
              just want to buy something or just want to search something,
              Google is something we can rely on. That's why getting a Google
              Ads service would be a great choice for a stronger digital
              presence. From keyword analysis to campaign tracking and
              reporting, we manage all. <br /> <br />
              We identify high-searched keywords according to your niche and
              perfect geographical location where we can target your business.
              We strategically manage bids to get the most clicks and
              conversions at the lowest CPC. Our team offers close-in reports
              highlighting clicks, conversions, ROI, and room for improvement.
              That's how we became the best digital marketing company in Delhi.
            </h6>
          </div>
        </div>
      </div>
      ...
      <div className="pt-8 md:pt-14 lg:pt-24">
        <div className="max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30 items-center">
          <div>
            ...
            <h6 className="text-sm lg:text-[16px] font-base text-[#545e5b] mt-2 font-light">
              Google Ads is perhaps the most effective online tool for reaching
              out to prospects. At Digital Market Tap, we develop and manage
              high-quality campaigns that produce tangible results. Call us
              today to start using Google Ads and bring your business to a whole
              new level!
            </h6>
          </div>
      ...
      <div className="pb-4 pt-2 md:pt-8 lg:pt-18">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl text-center font-semibold pb-4">
          What is included in our Google Ads services?{" "}
        </h1>
        <h6 className="text-center text-md font-base text-gray-500 pb-4 font-light">
          Get personalized Google Ads service, especially targeting the audience
          according to your niche. Our Google Ads service includes:
        </h6>
      </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 md:pt-12 px-0 md:px-4">
        <div className="hidden lg:flex rounded-[60px] overflow-hidden bg-black">
          <div className="w-1/3 p-12 flex flex-col gap-3 text-white relative">
            {tabs.map((tab, index) => {
      ...
      <div className="pb-8 pt-18">
       ...
       What makes our Google Ads <br /> management services so effective?
        </h1>
      ...
      <div className="pb-4 pt-8 md:pt-12 lg:pt-18">
       ...
       How do Google Ads boost your numbers?{" "}
        </h1>
          ...
          <div className="max-w-8xl mx-auto grid md:grid-cols-2  lg:grid-cols-3 gap-6 pt-4">
            <div className="text-left px-8 py-10 border border-[#E2E2E2] rounded-[40px] bg-white">
              ...
              <h6 className="text-[#5c5f61] font-light">
                more growth rate in brand visibility for those who got our Google Ads management
service.
              </h6>
            </div>
            <div className="text-left px-8 py-10 border border-[#E2E2E2] rounded-[40px] bg-white">
              <div className="flex items-center gap-4 mb-6 justify-between">
               ...
               <h6 className="text-[#5c5f61] font-light">
                 more growth rate in brand awareness for those who got our Google Ads
management service.
              </h6>
            </div>
            <div className="text-left px-8 py-10 border border-[#E2E2E2] rounded-[40px] bg-white">
              <div className="flex items-center gap-4 mb-6 justify-between">
               ...
               <h6 className="text-[#5c5f61] font-light">
                more growth on genuine leads who got our Google Ads management service.
              </h6>
            </div>
          </div>
        </div>
      ...
      <div className=" relative">
        <section className="bg-[#f8f8fb] rounded-[30px] md:rounded-[60px] py-12 px-4 sm:px-6 md:px-12 overflow-hidden max-w-7xl mx-auto my-12 text-center shadow-sm">
          <img
            src={RocketBlue}
            alt="Custom"
            className="hidden md:block w-14 md:w-18 absolute right-2 md:right-12 -top-8 -rotate-25 origin-top z-10"
          />
