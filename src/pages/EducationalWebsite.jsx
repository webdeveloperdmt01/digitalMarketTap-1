...
import EducationWebsite1 from "../assets/educational1.png";
import EducationWebsite2 from "../assets/educational2.jpg";
...
import SnipetPreview from "../components/SnipetPreview"
...
const EducationalWebsite = () => {
  ...
  <div className="pt-5 pb-10">
           <div className="max-w-7xl mx-auto rounded-[40px] overflow-hidden mb-8 md:mb-12">
             <img src={EducationWebsite2} alt="Team Collaboration" className="w-full h-[155px] md:h-[285px] lg:h-[520px] object-fit" />
           </div>
